...
Carrinho de Compras Interativo: Adicione, remova e altere a quantidade de itens facilmente.

Cálculo em Tempo Real: O subtotal é atualizado automaticamente a cada alteração no carrinho.
...
Baixe o executável: Faça o download do arquivo LanchoneteDragao2-1.0-SNAPSHOT.jar na seção de Releases deste repositório.
